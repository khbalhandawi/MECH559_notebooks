...
def SBJ_opt1(x, y):
  ...
  inputs = {}
  for input_name,value in zip(["SFC","We","ESF","L","D","LD","Ws","Wf","theta"],x): # these are your targets
...
def SBJ():
  ...
  v = {
    ...
    "var3":   {"index": 3,  "sp_index": 1,  f"name": "ESF",       "coupling_type": fb,  "link": 2,    "lb": 0.5,  "ub": 1.5,    "baseline": 1.0},
    "var4":   {"index": 4,  "sp_index": 1,  f"name": "D",         "coupling_type": ff,  "link": 2,    "lb": 1000, "ub": 70000,  "baseline": 1.0},
    "var5":   {"index": 5,  "sp_index": 1,  f"name": "Wt",        "coupling_type": ff,  "link": 3,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var6":   {"index": 6,  "sp_index": 1,  f"name": "theta",     "coupling_type": ff,  "link": 3,    "lb": 0.2,  "ub": 50,     "baseline": 1.0},
    "var7":   {"index": 7,  "sp_index": 1,  f"name": "ESF",       "coupling_type": ff,  "link": 3,    "lb": 0.5,  "ub": 1.5,    "baseline": 1.0},
    "var8":   {"index": 8,  "sp_index": 1,  f"name": "L",         "coupling_type": fb,  "link": 3,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var9":   {"index": 9,  "sp_index": 1,  f"name": "D",         "coupling_type": fb,  "link": 3,    "lb": 1000, "ub": 70000,  "baseline": 1.0},
    "var10":  {"index": 10, "sp_index": 1,  f"name": "LD",        "coupling_type": fb,  "link": 3,    "lb": 0.1,  "ub": 10,     "baseline": 1.0},
    "var11":  {"index": 11, "sp_index": 1,  f"name": "L",         "coupling_type": ff,  "link": 4,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var12":  {"index": 12, "sp_index": 1,  f"name": "Ws",        "coupling_type": fb,  "link": 4,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var13":  {"index": 13, "sp_index": 1,  f"name": "Wf",        "coupling_type": fb,  "link": 4,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var14":  {"index": 14, "sp_index": 1,  f"name": "theta",     "coupling_type": fb,  "link": 4,    "lb": 0.2,  "ub": 50,     "baseline": 1.0},
    ## Subproblem 2:
    "var15":  {"index": 15, "sp_index": 2,  f"name": "SFC",       "coupling_type": ff,  "link": 1,    "lb": 1,    "ub": 4,      "baseline": 1.0},
    "var16":  {"index": 16, "sp_index": 2,  f"name": "We",        "coupling_type": ff,  "link": 1,    "lb": 100,  "ub": 30000,  "baseline": 1.0},
    "var17":  {"index": 17, "sp_index": 2,  f"name": "ESF",       "coupling_type": ff,  "link": 1,    "lb": 0.5,  "ub": 1.5,    "baseline": 1.0},
    "var18":  {"index": 18, "sp_index": 2,  f"name": "D",         "coupling_type": fb,  "link": 1,    "lb": 1000, "ub": 70000,  "baseline": 1.0},
    # local variables:
    "var19":  {"index": 19, "sp_index": 2,  f"name": "T",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 1.0,    "baseline": 1.0},
    ## Subproblem 3:
    "var20":  {"index": 20, "sp_index": 3,  f"name": "Wt",        "coupling_type": fb,  "link": 1,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var21":  {"index": 21, "sp_index": 3,  f"name": "theta",     "coupling_type": fb,  "link": 1,    "lb": 0.2,  "ub": 50,     "baseline": 1.0},
    "var22":  {"index": 22, "sp_index": 3,  f"name": "ESF",       "coupling_type": fb,  "link": 1,    "lb": 0.5,  "ub": 1.5,    "baseline": 1.0},
    "var23":  {"index": 23, "sp_index": 3,  f"name": "L",         "coupling_type": ff,  "link": 1,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var24":  {"index": 24, "sp_index": 3,  f"name": "D",         "coupling_type": ff,  "link": 1,    "lb": 1000, "ub": 70000,  "baseline": 1.0},
    "var25":  {"index": 25, "sp_index": 3,  f"name": "LD",        "coupling_type": ff,  "link": 1,    "lb": 0.1,  "ub": 10,     "baseline": 1.0},
    # shared variables:
    "var26":  {"index": 26, "sp_index": 3,  f"name": "tc",        "coupling_type": s,   "link": 4,    "lb": 0.01, "ub": 0.1,    "baseline": 1.0},
    "var27":  {"index": 27, "sp_index": 3,  f"name": "ARw",       "coupling_type": s,   "link": 4,    "lb": 2.5,  "ub": 8.0,    "baseline": 1.0},
    "var28":  {"index": 28, "sp_index": 3,  f"name": "LAMBDAw",   "coupling_type": s,   "link": 4,    "lb": 40.,  "ub": 70.,    "baseline": 1.0},
    "var29":  {"index": 29, "sp_index": 3,  f"name": "Sref",      "coupling_type": s,   "link": 4,    "lb": 200., "ub": 800.,   "baseline": 1.0},
    "var30":  {"index": 30, "sp_index": 3,  f"name": "Sht",       "coupling_type": s,   "link": 4,    "lb": 50,   "ub": 148.9,  "baseline": 1.0},
    "var31":  {"index": 31, "sp_index": 3,  f"name": "ARht",      "coupling_type": s,   "link": 4,    "lb": 2.5,  "ub": 8.5,    "baseline": 1.0},
    # local variables:
    "var32":  {"index": 32, "sp_index": 3,  f"name": "LAMBDAht",  "coupling_type": un,  "link": None, "lb": 40.,  "ub": 70.,    "baseline": 1.0},
    "var33":  {"index": 33, "sp_index": 3,  f"name": "Lw",        "coupling_type": un,  "link": None, "lb": 0.01, "ub": 0.2,    "baseline": 1.0},
    "var34":  {"index": 34, "sp_index": 3,  f"name": "Lht",       "coupling_type": un,  "link": None, "lb": 1,    "ub": 3.5,    "baseline": 1.0},
    ## Subproblem 4:
    "var35":  {"index": 35, "sp_index": 4,  f"name": "L",         "coupling_type": fb,  "link": 1,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var36":  {"index": 36, "sp_index": 4,  f"name": "Ws",        "coupling_type": ff,  "link": 1,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var37":  {"index": 37, "sp_index": 4,  f"name": "Wf",        "coupling_type": ff,  "link": 1,    "lb": 5000, "ub": 100000, "baseline": 1.0},
    "var38":  {"index": 38, "sp_index": 4,  f"name": "theta",     "coupling_type": ff,  "link": 1,    "lb": 0.2,  "ub": 50,     "baseline": 1.0},
    # shared variables:
    "var39":  {"index": 39, "sp_index": 4,  f"name": "tc",        "coupling_type": s,   "link": 3,    "lb": 0.01, "ub": 0.1,    "baseline": 1.0},
    "var40":  {"index": 40, "sp_index": 4,  f"name": "ARw",       "coupling_type": s,   "link": 3,    "lb": 2.5,  "ub": 8.0,    "baseline": 1.0},
    "var41":  {"index": 41, "sp_index": 4,  f"name": "LAMBDAw",   "coupling_type": s,   "link": 3,    "lb": 40.,  "ub": 70.,    "baseline": 1.0},
    "var42":  {"index": 42, "sp_index": 4,  f"name": "Sref",      "coupling_type": s,   "link": 3,    "lb": 200., "ub": 800.,   "baseline": 1.0},
    "var43":  {"index": 43, "sp_index": 4,  f"name": "Sht",       "coupling_type": s,   "link": 3,    "lb": 50,   "ub": 148.9,  "baseline": 1.0},
    "var44":  {"index": 44, "sp_index": 4,  f"name": "ARht",      "coupling_type": s,   "link": 3,    "lb": 2.5,  "ub": 8.5,    "baseline": 1.0},
    # local variables:
    "var45":  {"index": 45, "sp_index": 4,  f"name": "lambda",    "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 0.4,    "baseline": 1.0},
    "var46":  {"index": 46, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var47":  {"index": 47, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var48":  {"index": 48, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var49":  {"index": 49, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var50":  {"index": 50, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var51":  {"index": 51, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var52":  {"index": 52, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var53":  {"index": 53, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var54":  {"index": 54, "sp_index": 4,  f"name": "t",         "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 4.0,    "baseline": 1.0},
    "var55":  {"index": 55, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var56":  {"index": 56, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var57":  {"index": 57, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var58":  {"index": 58, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var59":  {"index": 59, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var60":  {"index": 60, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var61":  {"index": 61, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var62":  {"index": 62, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    "var63":  {"index": 63, "sp_index": 4,  f"name": "ts",        "coupling_type": un,  "link": None, "lb": 0.1,  "ub": 9.0,    "baseline": 1.0},
    # INTERMEDIATE VARIABLES
    "var64":  {"index": 64, "sp_index": 1,  f"name": "range", "coupling_type": dum,  "link": None, "lb": 0.0,  "ub": 0.0,    "baseline": 1.0},
    "var65":  {"index": 65, "sp_index": 2,  f"name": "Temp_E", "coupling_type": dum,  "link": None, "lb": 0.0,  "ub": 0.0,    "baseline": 1.0},
    "var66":  {"index": 66, "sp_index": 2,  f"name": "Throttle_uA", "coupling_type": dum,  "link": None, "lb": 0.0,  "ub": 0.0,    "baseline": 1.0},
    "var67":  {"index": 67, "sp_index": 3,  f"name": "Pg", "coupling_type": dum,  "link": None, "lb": 0.0,  "ub": 0.0,    "baseline": 1.0},
    "var68":  {"index": 68, "sp_index": 3,  f"name": "CLo1", "coupling_type": dum,  "link": None, "lb": 0.0,  "ub": 0.0,    "baseline": 1.0},
    "var69":  {"index": 69, "sp_index": 3,  f"name": "CLo2", "coupling_type": dum,  "link": None, "lb": 0.0,  "ub": 0.0,    "baseline": 1.0},
  }
  ...
  V1 = get_inputs(V,["SFC","We","ESF","L","D","LD","Ws","Wf","theta"],sp_index=1) # inputs
  R1 = get_outputs(V,["D","Wt","theta","ESF","L"],sp_index=1)
