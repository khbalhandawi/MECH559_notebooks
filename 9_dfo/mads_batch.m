...
problemPath = fullfile(pwd,'');
Problem.File.F = 'bb';                    % functions file
Problem.File.O = 'bb_Omega';              % linear constraints file
Problem.File.X = 'bb_X';                  % closed constraints file
Problem.File.I = 'bb_x0';                 % initial points file
Problem.File.N = 'bb_N';                  % discrete neighbor file (MVP only)
Problem.File.P = 'bb_Param';              % parameter file
Problem.File.C = 'bb_Cache.mat';          % previously created Cache file
Problem.File.S = 'bb_Session.mat';        % previously created Session file
Problem.File.H = 'bb_History.txt';        % iteration history text file
Problem.File.D = 'bb_Debug.txt';          % debug log file
